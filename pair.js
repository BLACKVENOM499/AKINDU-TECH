...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    IMAGE_PATH: 'https://files.catbox.moe/z67iul.png',
    GROUP_INVITE_LINK: '',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: 'https://files.catbox.moe/z67iul.png',
    NEWSLETTER_JID: '120363404965926337@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    version: '1.0.0',
    OWNER_NUMBER: '94741856766',
    BOT_FOOTER: '> 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 𝐕.2 🥷🇱🇰',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbCLB4pDuMRfSmsDyQ1E'
};
...
`;
        const aliveMessage = {
            image: { url: "https://files.catbox.moe/z67iul.png" },
...
User Message: ${q}
  ...
  await socket.sendMessage(sender, {
        image: { url: 'https://files.catbox.moe/bm2v7m.jpg' }, // Replace with your AI response image
        caption: response,
        ...messageContext
    }, { quoted: fakevCard });
